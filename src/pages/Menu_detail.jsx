...
const MenuDetail = () => {
  ...
  useEffect(() => {
    // If no menu item is selected, redirect back to the menu order page
    if (!selectedMenu) {
      navigate('/menu_order');
    }
          ...
          {selectedMenu ? (
            <div>
              <img
                ...
                src={`http://localhost:5000/api/menuimage/${selectedMenu.Menu_id}`}
            ...
            <p>No menu item selected. Please go back and choose a menu.</p>
          )}
        </div>
      </div>
