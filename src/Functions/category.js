...
export function showallmenu() {
    fetch('http://localhost:5000/api/noodle')
        ...
        .then(data => {
            ...
            data.forEach(item => {
                ...
                pictureElement.src = `http://localhost:5000/api/noodleimage/${item.Noodle_menu_id}`;
    ...
    fetch('http://localhost:5000/api/menu')
        ...
        .then(data => {
            ...
            data.forEach(item => {
                ...
                const pictureElement = document.createElement('img');
                pictureElement.className = 'menu-picture';
                pictureElement.src = `http://localhost:5000/api/menuimage/${item.Menu_id}`;
...
function showNamTok() {
    fetch('http://localhost:5000/api/namtok')
        .then(response => response.json())
        .then(data => {
...
function showNamSai() {
    fetch('http://localhost:5000/api/namsai')
        .then(response => response.json())
        .then(data => {
...
function showdrynoodle() {
    fetch('http://localhost:5000/api/drynoodle')
        .then(response => response.json())
        .then(data => {
